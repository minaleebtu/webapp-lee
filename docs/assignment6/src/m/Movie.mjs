 ...
 */
import {cloneObject, isIntegerOrIntegerString, createIsoDateString,
    isNonEmptyString, isPositiveInteger} from "../../lib/util.mjs";
import {
    ConstraintViolation, FrozenValueConstraintViolation, IntervalConstraintViolation,
    MandatoryValueConstraintViolation,
    NoConstraintViolation, RangeConstraintViolation, StringLengthConstraintViolation,
 ...
 * @method
 * @static
 * @param {{movieId: number, title: string, releaseDate: date, category: ?number,
 * tvSeriesName: ?string, episodeNo: ?number, about: ?string}} slots - A record of parameters.
 * @returns {object}
 */
