...
function generateTestData() {
  try {
    ...
    Movie.instances[1] = new Movie({movieId: 1, title: "Pulp Fiction",
      releaseDate: new Date("1994-05-12"), director_id: 3, actorIdRefs: [5,6]});
    Movie.instances[2] = new Movie({movieId: 2, title: "Star Wars",
      releaseDate: new Date("1977-05-25"), director_id: 2, actorIdRefs: [7,8]});
    Movie.instances[3] = new Movie({movieId: 3, title: "Dangerous Liaisons",
      releaseDate: new Date("1988-12-16"), director_id: 1, actorIdRefs: [9,5]});
    Movie.saveAll();
